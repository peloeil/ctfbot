...
```
ctf_team/cog.py  → campaign.py, discord_ops.py, db.py, helpers.py, runtime.py
...
```python
optional_channel_id = read_int(..., default=0) or None
```
